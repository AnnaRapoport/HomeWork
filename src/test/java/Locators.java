...
public class Locators {
    WebDriver wd;
        ...
        public void homework1() {
            ...
            WebElement el36 = wd.findElement(By.cssSelector("[placeholder='Password']"));
            WebElement el37 = wd.findElement(By.xpath("//*[@placeholder='Password']"));
            WebElement el38 = wd.findElement(By.xpath("//input[contains(@placeholder,'ss')]"));

            WebElement el39 = wd.findElement(By.name("login"));//???
            WebElement el40 = wd.findElement(By.cssSelector("[name='login']"));
            WebElement el41 = wd.findElement(By.xpath("//button[@name='login']"));
